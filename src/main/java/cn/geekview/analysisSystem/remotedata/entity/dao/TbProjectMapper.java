...
public interface TbProjectMapper {
	 ...
	 * @return
	 */
	List<TdreamTbProject> getProductByOriginIdWithDaySpace(@Param("originId")Integer OriginId);
	 ...
	 * @return
	 */
	List<TdreamTbProject> selectListByUpdateDate(@Param("updateDate")Date updateDate);
